...
// Stripe fees excluded — tracked automatically by the site.
// Tina's €300 flat fee appears each event (she keeps it from cash she collects).
const EXPENSES = [
  // 29/4/2026 – Bambou
  ...
  { date: "2026-04-29", category: "Staff"     as const, description: "Tina – flat fee",  amountCents: 30000, paidBy: "Tina",           notes: "Bambou" },
  ...
  { date: "2026-05-21", category: "Staff"     as const, description: "Tina – flat fee",  amountCents: 30000, paidBy: "Tina",           notes: "Buddah Bar" },
